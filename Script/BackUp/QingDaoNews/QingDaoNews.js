...
async function main() {
    ...
    for (const item of arr) {
        ...
        for (let i = 0; i < lotteryCount.result.user.free_num; i++) {
            ...
            console.log(`抽奖获得：${prizeList[index].name}`)
        }
        console.log("————————————")
        console.log("开始任务")
        ...
        console.log(`拥有贝壳：${detail.result.gold}\n`)
        notice += `用户：${phone} 贝壳：${detail.result.gold}\n`
    }
    if (notice) {
